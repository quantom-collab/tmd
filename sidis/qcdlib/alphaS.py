...
class ALPHAS:
    ...
    def __init__(self):
        ...
        for Nf in range(3,7): 
            ...
            self.beta[Nf,3]=29243.0 - 6946.30 * Nf + 405.089 * Nf**2 + 1093/729 * Nf**3
    ...
    def beta_func(self,a,Nf):
        ...
        if cfg.alphaS_order>=2: betaf+=-a**2*self.beta[Nf,2]
        if cfg.alphaS_order>=3: betaf+=-a**3*self.beta[Nf,3]
        return betaf*a**2
